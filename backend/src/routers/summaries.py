...
async def generate_summary_stream(blocks_content: str):
    ...
    with open("/Users/nathan/Developments/Repositories/paperly/backend/prompts/generate_summary_for_block.txt", "r") as f:
        prompt_template = f.read()
    
    # Format the prompt with the blocks content
    prompt = prompt_template.format(blocks_content=blocks_content)
...
def format_block_content(block: BlockMixin) -> str:
    """
...
async def create_summary(request: SummaryRequest):
    ...
    :param request: Request containing the list of block IDs to summarize.
    ...
    try:
        ...
        return StreamingResponse(
            generate_summary_stream(blocks_content),
